...
export default function Portfolio (){
    ...
    return (
        ...
        <h1> PORTFOLIO </h1>
            ...
            <img className = "single-img" src={"https://i.ibb.co/M9KzQSY/image00004.jpg"} alt="image00004" border="0"/>
            ...
            <img className = "single-img" src={"https://i.ibb.co/9HyJw3k/image00023.jpg"} alt="image00023" border="0"/>
            <img className = "single-img" src={"https://i.ibb.co/cybYT6Y/image00017.jpg"} alt="image00017" border="0"/>
            <img className = "single-img" src={"https://i.ibb.co/HtQjbYK/image00025.jpg"} alt="image00025" border="0"/>
